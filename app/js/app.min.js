...
document.addEventListener('DOMContentLoaded', function () {
  ...
  core_class.use([scrollbar_scrollbar]);
  core_class.use([pagination]);
  core_class.use([autoplay]);
  core_class.use([controller]); // SET CONFIG END
  // HEADER FUNCTIONS
  ...
  if ($(window).width() >= 768) {
    $('.newheader-contacts__phone').hover(function () {
  ...
  var menuMobile = document.getElementById('mobile_menu_container');
  menuMobile.addEventListener('touchstart', handleTouchStart, {
    passive: true
  });
  menuMobile.addEventListener('touchmove', handleTouchMove, {
    passive: true
  });
  var x1 = null;
  var y1 = null;
  ...
  var sidebarSlider = new core_class('.sidebar-banners', {
    loop: true,
    autoplay: {
      delay: 7000,
      disableOnInteraction: true
  ...
  var productDaySlider = new core_class('.product-day-slider', {
    loop: true,
    autoplay: {
      delay: 7000,
      disableOnInteraction: true
  ...
  var productDaySidebarSlider = new core_class('.productday-sidebar-slider', {
    loop: true,
    autoplay: {
      delay: 7000,
      disableOnInteraction: true
  ...
  var indexSlider = new core_class(".indexnavslider", {
    slidesPerView: "auto",
    spaceBetween: 10,
    navigation: {
  ...
  var topSlider = new core_class('.topslider-main', {
    loop: true,
    pagination: {
  ...
  if ($('.swiper-filterslider').length) {
    var swiperFilters = Array;
    $('.swiper-filterslider').each(function () {
      var id = $(this).data('id');
      swiperFilters[id] = new core_class('.swiper-filterslider[data-id="' + id + '"]', {
        grabCursor: true,
        observer: true,
        slidesPerView: 5,
        slidesPerColumn: 1,
      ...
      $('.filterslider-categories[data-id="' + id + '"]').on('click', 'li', function () {
        ...
        swiperFilters[id].slideTo(0); // filterSlider.scrollbar.updateSize();
  ...
  if ($('.swiper-filterslider_analog').length) {
    var _swiperFilters = Array;
    $('.swiper-filterslider_analog').each(function () {
      var id = $(this).data('id');
      _swiperFilters[id] = new core_class('.swiper-filterslider_analog[data-id="' + id + '"]', {
        grabCursor: true,
        observer: true,
        slidesPerView: 4,
        slidesPerColumn: 1,
      ...
      $('.filterslider-categories[data-id="' + id + '"]').on('click', 'li', function () {
        ...
        _swiperFilters[id].updateSize();

        _swiperFilters[id].updateSlides();

        _swiperFilters[id].updateSlidesClasses();

        _swiperFilters[id].slideTo(0); // filterSlider.scrollbar.updateSize();
        // filterSlider.updateProgress();
  ...
  if ($('.newsblock-categories li').length) {
    ...
    var swiperNews = Array;
    $('.newsblock-categories li').each(function (i, elem) {
      swiperNews[elem.dataset.category] = new core_class('.swiper-news[data-category="' + elem.dataset.category + '"]', {
        slidesPerView: 6,
        spaceBetween: 10,
        slidesPerColumn: 1,
        // And if we need scrollbar
    ...
    }, 400); //Отображаем нужный слайдер при смене категорий
  ...
  var swiperReviews = new core_class(".swiper-reviews", {
    effect: "coverflow",
    grabCursor: true,
    loop: true,
    // spaceBetween: 45,
  ...
  var swiperBrands = new core_class('.swiper-brands', {
    // Optional parameters
    direction: 'horizontal',
    slidesPerView: 'auto',
    slidesPerColumn: 2,
  ...
  if ($('.element-stickyinfo').length) {
    $(window).scroll(function () {// stickyInfoCard();
    });
    $(window).resize(function () {// stickyInfoCard();
    });
  }
  ...
  var swiperThumb = new core_class(".element-gallery-thumb", {
    // loop: true,
    direction: "horizontal",
    spaceBetween: 10,
    slidesPerView: 4,
  ...
  var swiperMain = new core_class(".element-gallery-main", {
    // loop: true,
    thumbs: {
      swiper: swiperThumb
    }
  ...
  $('.catalog-elements-item-productday__timer,.product-day-slider-item-productday__timer,.element-productday__timer,.productday-sidebar-slider-item-productday__timer').countdown({
    compact: true,
    description: '',
  ...
  var catalogSlider = new core_class('.catalog-banners', {
    loop: true,
    autoHeight: true,
    autoplay: {
      delay: 7000,
  ...
  var catalogSlider = new core_class('.catalog-banners_mobile', {
    loop: true,
    autoHeight: true,
    autoplay: {
      delay: 7000,
